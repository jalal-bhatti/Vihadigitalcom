...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Vihadigitalcom_Banners::banners');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Vihadigitalcom_Banners::banners')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Vihadigitalcom\Banners\Model\Banners');
