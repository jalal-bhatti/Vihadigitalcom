 ...
 */
namespace Vihadigitalcom\Banners\Controller\Adminhtml\Index;

use Magento\Backend\App\Action\Context;
use Magento\Backend\App\Action;
use Vihadigitalcom\Banners\Model\Banners;
   ...
   //  protected $filter;
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Vihadigitalcom\Banners\Model\Banners')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('vihadigitalcom_banners');
            ...
            $this->dataPersistor->set('vihadigitalcom_banners', $data);
